...
def res2net50_v1b(pretrained=False, root="~/work/PdSeg/models", **kwargs):
    ...
    if pretrained:
        ...
        model_path = os.path.join(os.path.expanduser(root), "backbone/res2net", "res2net50_v1b")
        state_dict = fluid.dygraph.load_dygraph(model_path)
        model.load_dict(state_dict[0])
    return model


def res2net101_v1b(pretrained=False, root="~/work/PdSeg/models", **kwargs):
    ...
    if pretrained:
        # model_path = r"E:\Code\Python\PaddleSeg\Res2Net\res2net50_v1b_26w_4s-3cf99910.pth"
        model_path = os.path.join(os.path.expanduser(root), "backbone/res2net", "res2net101_v1b")
        state_dict = fluid.dygraph.load_dygraph(model_path)
        model.load_dict(state_dict[0])
    return model
