...
if __name__ == '__main__':
    with fluid.dygraph.guard():
        ...
        from PdSeg.models.backbone.resnest import resnest
        import torch
        model_th = torch.load(r"C:\Users\wuyang\Desktop\resnest269-0cc87c48.pth", map_location=torch.device("cpu"))
        model_pd = resnest.resnest269(pretrained=False)
        model_path = "./resnest269_en"
        convert_params(model_th, model_pd, model_path)